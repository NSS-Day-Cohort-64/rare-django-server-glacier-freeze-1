...
class Post(models.Model):
    ...
    tags = models.ManyToManyField("Tag", through="PostTag", related_name="posts_with_tag")
    reactions = models.ManyToManyField("Reaction", through="PostReaction", related_name="posts_with_reaction")
